...
var instance = new __WEBPACK_IMPORTED_MODULE_0_vee_validate__["a" /* Validator */]();
...
instance.extend('unique', {
    getMessage: function getMessage(field) {
        return 'Please pick up another ' + field + '. This one is already used.';
    },
    validate: function validate(value, _ref) {
        var _ref2 = _slicedToArray(_ref, 1),
            uniqueTo = _ref2[0];

        return isUnique(value, uniqueTo);
    }
});
